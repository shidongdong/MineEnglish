...
- (BOOL) isTomorrow
{
    return [self isEqualToDateTime:[NSDate dateTomorrow]];
}

- (BOOL) isYesterday
{
    return [self isEqualToDateTime:[NSDate dateYesterday]];
}
...
+ (NSDate *) dateByDateString:(NSString *)dateString format:(NSString *)format
{
