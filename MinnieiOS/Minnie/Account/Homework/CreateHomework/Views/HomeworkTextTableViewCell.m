...
NSString * const HomeworkTextTableViewCellId = @"HomeworkTextTableViewCellId";

@interface HomeworkTextTableViewCell()
...
@implementation HomeworkTextTableViewCell
