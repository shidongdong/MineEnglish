...
- (void)setActInfo:(ActivityInfo *)actInfo{
    ...
    [self.headerImagV sd_setImageWithURL:[self.actInfo.actCoverUrl imageURLWithWidth:ScreenWidth] placeholderImage:[UIImage imageNamed:@"attachment_placeholder"] completed:nil];
